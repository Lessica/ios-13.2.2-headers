...
@interface NWConcrete_nw_path_parameters : NSObject <OS_nw_path_parameters> {
    ...
    /* Warning: unhandled struct encoding: '{nw_parameters_extended_objects=@@@@@@@@@@@@@@@}' */ struct nw_parameters_extended_objects { id x1; id x2; id x3; id x4; id x5; id x6; id x7; id x8; } * extended_objects;
