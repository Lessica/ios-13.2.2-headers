...
@interface NSObject <ATXScoreLogSerializable, CAAnimatableValue, CARenderValue, CKLParsedObject, DebugHierarchyObject_Fallback, INCodableAttributeRelationComparing, MAPropertyTypeProtocol, NSObject, NSObjectInitJSExports, PQLResultSetInitializer, REDonatedActionIdentifierProviding, WFNaming, WFTyping, _DKProtobufConverting> {
    Class  isa;
}
