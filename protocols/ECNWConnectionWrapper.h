...
- (id /* block */)serverTrustHandler:(void *)arg1; // needs 1 arg types, found 5: id /* block */, struct __SecTrust { }*, id*, id, SEL
- (NSString *)service;
...
- (void)setServerTrustHandler:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, bool, id /* block */, struct __SecTrust { }*, id*
