...
- (void)loadDefaultSerializedRepresentationForEnumeration:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 11: WFEnumerationParameter *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id, void*, inout unsigned short, void*, const const out const void*, void*
