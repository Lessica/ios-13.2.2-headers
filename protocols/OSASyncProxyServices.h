...
- (void)request:(void *)arg1 transferLog:(void *)arg2 withOptions:(void *)arg3 onComplete:(void *)arg4; // needs 4 arg types, found 13: NSString *, NSString *, NSDictionary *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id, void*, inout unsigned short, void*, const const out const void*, void*
