...
- (void)generateObjectRepresentation:(void *)arg1 options:(void *)arg2 forClass:(void *)arg3; // needs 3 arg types, found 16: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id, void*, inout unsigned short, unsigned short, void*, const int, in void*, void*, NSError *, void*, WFCoercionOptions *, Class
