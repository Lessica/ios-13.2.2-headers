...
- (bool)isCancelled;
- (bool)isFinished;
- (<EFFuture> *)map:(void *)arg1; // needs 1 arg types, found 5: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, id, void*, id
...
- (void)onScheduler:(void *)arg1 addSuccessBlock:(void *)arg2; // needs 2 arg types, found 6: <EFScheduler> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id
...
- (<EFFuture> *)onScheduler:(void *)arg1 map:(void *)arg2; // needs 2 arg types, found 6: <EFScheduler> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, id, void*, id
...
- (<EFFuture> *)onScheduler:(void *)arg1 then:(void *)arg2; // needs 2 arg types, found 6: <EFScheduler> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, <EFFuture> *, id /* block */, id
...
- (<EFFuture> *)then:(void *)arg1; // needs 1 arg types, found 5: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, <EFFuture> *, id /* block */, id
- (bool)tryCancel;
