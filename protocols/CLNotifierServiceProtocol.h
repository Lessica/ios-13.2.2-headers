...
- (void)register:(void *)arg1 forNotification:(void *)arg2 registrationInfo:(void *)arg3; // needs 3 arg types, found 4: /* Warning: Unrecognized filer type: 'R' using 'void*' */ void*, <CLNotifierServiceClientProtocol> *, int, CLCppContainer *
