...
@interface PHMediaRequestContext : NSObject <PHAdjustmentDataRequestDelegate, PHImageRequestDelegate, PHResourceAvailabilityChangeRequestDelegate, PHResourceRepairRequestDelegate, PHVideoChoosingAndAvailabilityRequestDelegate, PHVideoRequestDelegate> {
    PHAsset * _asset;
