...
- (void)authorizeItemCompletionHandler_objc:(struct { id x1; struct __CFString {} x2; id x3; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x4; }*)arg1 picData:(struct __CFData { }*)arg2 playerGUID:(struct __CFString { }*)arg3 error:(int)arg4;
