...
@property (getter=_definition, nonatomic, readonly) struct { id x1; id x2; short x3; BOOL x4; unsigned char x5; }*definition;
...
- (void).cxx_destruct;
- (struct { id x1; id x2; short x3; BOOL x4; unsigned char x5; }*)_definition;
