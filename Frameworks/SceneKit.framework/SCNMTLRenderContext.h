...
@interface SCNMTLRenderContext : NSObject <SCNBufferStream> {
    ...
    int  _profile;
    struct SCNMTLRenderCommandEncoder { bool x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; bool x6; bool x7; bool x8; bool x9; unsigned int x10; unsigned int x11; bool x12; bool x13; struct { id x_14_1_1; } x14[31]; /* Warning: unhandled array encoding: '[128@][16@][31{?=@Q}][128@][16@]@@@^{SCNMTLBufferPool}[2Q][2Q]}' */ id x15[128]; struct { id x_16_1_1; } x16[31]; id x17[128]; id x18; id x19; struct SCNMTLBufferPool {} x20; unsigned long long x21[2]; unsigned long long x22[2]; } * _renderEncoder;
    struct { 
...
@property (nonatomic, readonly) struct SCNMTLComputeCommandEncoder { /* Warning: unhandled array encoding: '[31@][31Q][128@][16@]@@@^{SCNMTLBufferPool}I[2Q][1Q]}' */ id x1[31]; id x2[128]; id x3; id x4; struct SCNMTLBufferPool {} x5; unsigned int x6; unsigned long long x7[2]; unsigned long long x8[1]; }*resourceComputeEncoder;
...
- (struct SCNMTLComputeCommandEncoder { /* Warning: unhandled array encoding: '[31@][31Q][128@][16@]@@@^{SCNMTLBufferPool}I[2Q][1Q]}' */ id x1[31]; id x2[128]; id x3; id x4; struct SCNMTLBufferPool {} x5; unsigned int x6; unsigned long long x7[2]; unsigned long long x8[1]; }*)resourceComputeEncoder;
- (id)resourceGroup;
- (id)resourceManager;
- (id)resourceQueue;
- (bool)reverseZ;
