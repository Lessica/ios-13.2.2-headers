...
+ (struct __SecIdentity { }*)copySecIdentity:(struct NSMutableData { Class x1; }*)arg1;
+ (id)copySignHashDataForSet:(id)arg1;
+ (id)copySignHashDataForSet:(id)arg1 authentication:(id)arg2;
+ (struct __SecKey { struct __CFRuntimeBase { unsigned long long x_1_1_1; unsigned long long x_1_1_2; } x1; struct __SecKeyDescriptor {} *x2; void *x3; }*)copyTrustedKeyForCertificate:(id)arg1 remoteCAArray:(id)arg2 policyRef:(void*)arg3 enableRevocationCheck:(bool)arg4 strictRevocationCheck:(bool)arg5;
...
+ (struct NSMutableData { Class x1; }*)createHMACFromData:(id)arg1 key:(id)arg2 integrityAlgorithm:(unsigned long long)arg3;
+ (struct NSMutableData { Class x1; }*)createHMACFromData:(id)arg1 key:(id)arg2 prfAlgorithm:(unsigned long long)arg3;
...
+ (struct NSMutableData { Class x1; }*)createPRFPlusFromData:(id)arg1 key:(id)arg2 prfAlgorithm:(unsigned long long)arg3 outputLength:(unsigned int)arg4;
...
+ (bool)verifySignature:(id)arg1 octets:(id)arg2 hashAlgorithm:(unsigned long long)arg3 publicKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x_1_1_1; unsigned long long x_1_1_2; } x1; struct __SecKeyDescriptor {} *x2; void *x3; }*)arg4 padding:(unsigned int)arg5;
+ (bool)verifySignature:(id)arg1 octets:(id)arg2 hashAlgorithm:(unsigned long long)arg3 publicKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x_1_1_1; unsigned long long x_1_1_2; } x1; struct __SecKeyDescriptor {} *x2; void *x3; }*)arg4 padding:(unsigned int)arg5 sha2:(bool)arg6;
