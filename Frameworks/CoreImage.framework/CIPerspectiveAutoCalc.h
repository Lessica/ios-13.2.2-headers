...
- (id)debugImage;
- (bool)generateDebugImage;
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const /* Warning: unhandled struct encoding: '{?=dddddd@}' */ struct { double x1; double x2; double x3; double x4; double x5; double x6; id x7; }*)arg3;
- (double)pitch;
- (long long)pitchFailureReason;
- (double)roll;
