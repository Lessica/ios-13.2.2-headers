...
@interface _MTLLibrary : _MTLObjectWithLabel <MTLLibrarySPI> {
    /* Warning: unhandled struct encoding: '{MTLLibraryContainer=^{MTLPipelineCollection}i{?=[32C]}^{MTLLibraryData}@@@@@}' */ struct MTLLibraryContainer { struct MTLPipelineCollection {} *x1; int x2; struct { unsigned char x_3_1_1[32]; } x3; struct MTLLibraryData {} *x4; id x5; id x6; id x7; } * _cacheEntry;
    <MTLDevice> * _device;
    NSMutableDictionary * _functionDictionary;
    struct MTLLibraryData { int (**x1)(); int x2; id x3; } * _libraryData;
}

@property (readonly) /* Warning: unhandled struct encoding: '{MTLLibraryContainer=^{MTLPipelineCollection}i{?=[32C]}^{MTLLibraryData}@@@@@}' */ struct MTLLibraryContainer { struct MTLPipelineCollection {} *x1; int x2; struct { unsigned char x_3_1_1[32]; } x3; struct MTLLibraryData {} *x4; id x5; id x6; id x7; }*cacheEntry;
...
- (/* Warning: unhandled struct encoding: '{MTLLibraryContainer=^{MTLPipelineCollection}i{?=[32C]}^{MTLLibraryData}@@@@@}' */ struct MTLLibraryContainer { struct MTLPipelineCollection {} *x1; int x2; struct { unsigned char x_3_1_1[32]; } x3; struct MTLLibraryData {} *x4; id x5; id x6; id x7; }*)cacheEntry;
- (void)dealloc;
- (id)description;
- (id)device;
...
- (id)functionNames;
- (id)initWithLibraryContainer:(/* Warning: unhandled struct encoding: '{MTLLibraryContainer=^{MTLPipelineCollection}i{?=[32C]}^{MTLLibraryData}@@@@@}' */ struct MTLLibraryContainer { struct MTLPipelineCollection {} *x1; int x2; struct { unsigned char x_3_1_1[32]; } x3; struct MTLLibraryData {} *x4; id x5; id x6; id x7; }*)arg1 device:(id)arg2;
