...
@interface MTLIOAccelResourcePool : NSObject {
    ...
    struct _MTLIOAccelResourcePoolPrivate { 
        /* Warning: unhandled struct encoding: '{_MTLIOAccelResourceQueue="tqh_first"@"MTLIOAccelPooledResource""tqh_last"^@}"nonvolatileQueue"{_MTLIOAccelResourceQueue="tqh_first"@"MTLIOAccelPooledResource""tqh_last"^@}"lock"{os_unfair_lock_s="_os_unfair_lock_opaque"I}"count"i}' */ struct _MTLIOAccelResourceQueue { 
