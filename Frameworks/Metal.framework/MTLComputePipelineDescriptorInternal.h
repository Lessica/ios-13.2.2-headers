...
- (const struct MTLComputePipelineDescriptorPrivate { id x1; bool x2; unsigned short x3; id x4; id x5; bool x6; bool x7; unsigned int x8; void *x9; }*)_descriptorPrivate;
- (id)buffers;
- (id)computeFunction;
