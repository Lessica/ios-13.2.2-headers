...
- (const /* Warning: unhandled struct encoding: '{MTLFunctionData=QQQQQSSSS{?=[32C]}C@Cb2b6@}' */ struct MTLFunctionData { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned short x6; unsigned short x7; unsigned short x8; unsigned short x9; struct { unsigned char x_10_1_1[32]; } x10; unsigned char x11; id x12; unsigned int x13 : 2; unsigned int x14 : 6; id x15; }*)functionData;
- (id)functionInputs;
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 libraryData:(struct MTLLibraryData { int (**x1)(); int x2; id x3; }*)arg3 functionData:(/* Warning: unhandled struct encoding: '{MTLFunctionData=QQQQQSSSS{?=[32C]}C@Cb2b6@}' */ struct MTLFunctionData { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned short x6; unsigned short x7; unsigned short x8; unsigned short x9; struct { unsigned char x_10_1_1[32]; } x10; unsigned char x11; id x12; unsigned int x13 : 2; unsigned int x14 : 6; id x15; }*)arg4 device:(id)arg5;
