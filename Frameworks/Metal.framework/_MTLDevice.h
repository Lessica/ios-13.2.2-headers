...
- (id)newComputePipelineWithDescriptor:(id)arg1 variant:(struct NSObject { Class x1; }*)arg2 errorMessage:(id*)arg3;
- (struct NSObject { Class x1; }*)newComputeVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;
...
- (void)releaseCacheEntry:(/* Warning: unhandled struct encoding: '{MTLLibraryContainer=^{MTLPipelineCollection}i{?=[32C]}^{MTLLibraryData}@@@@@}' */ struct MTLLibraryContainer { struct MTLPipelineCollection {} *x1; int x2; struct { unsigned char x_3_1_1[32]; } x3; struct MTLLibraryData {} *x4; id x5; id x6; id x7; }*)arg1;
