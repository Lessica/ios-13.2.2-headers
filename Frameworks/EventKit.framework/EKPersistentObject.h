...
- (id)init;
- (id)initWithAlternateUniverseObject:(struct EKPersistentObject { Class x1; struct _opaque_pthread_mutex_t { long long x_2_1_1; BOOL x_2_1_2[56]; } x2; id x3; id x4; id x5; }*)arg1 inEventStore:(id)arg2 withUpdatedChildObjects:(id)arg3;
