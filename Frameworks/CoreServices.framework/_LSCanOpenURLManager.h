...
+ (struct BindingEvaluator { id x1; id x2; id x3; unsigned long x4; unsigned short x5; oneway /* Warning: Unrecognized filer type: 'e' using 'void*' */ void*x6; const short x7; int x8; out in inout void*x9; void*x10; unsigned int x11/* : ? */; void*x12; const void*x13; unsigned char x14[32]; })bindingEvaluatorForScheme:(id)arg1;
...
- (id)copySchemesMap;
- (bool)findApplicationBundleID:(unsigned int*)arg1 bundleData:(const struct LSBundleData {}**)arg2 context:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg3 forXPCConnection:(id)arg4;
