...
+ (id)_appLinksWithState:(id)arg1 context:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg2 limit:(unsigned long long)arg3 URLComponents:(id)arg4 error:(id*)arg5;
+ (id)_appLinksWithState:(id)arg1 context:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg2 limit:(unsigned long long)arg3 requireEntitlement:(bool)arg4 error:(id*)arg5;
