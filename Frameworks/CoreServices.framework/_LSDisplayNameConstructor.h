...
+ (id)displayNameConstructorWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1 bundle:(unsigned int)arg2 bundleClass:(const unsigned int*)arg3 node:(id)arg4 preferredLocalizations:(id)arg5 error:(id*)arg6;
+ (id)displayNameConstructorWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1 node:(id)arg2 error:(id*)arg3;
+ (id)displayNameConstructorsWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1 node:(id)arg2 error:(id*)arg3;
...
- (bool)canSetExtensionHiddenWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1;
...
- (void)initNodeBitsWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1 node:(id)arg2 bundleClass:(const unsigned int*)arg3;
- (id)initWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1 node:(id)arg2 bundleClass:(const unsigned int*)arg3 desiredDisplayName:(id)arg4 treatAsFSName:(bool)arg5;
...
- (bool)mayHideExtensionWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1;
- (id)replaceForbiddenCharacters:(id)arg1;
- (bool)showExtensionWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1 asIfShowingAllExtensions:(id)arg2;
- (id)transformBeforeCombining:(id)arg1 needsBiDiControlCharacters:(bool*)arg2;
- (id)unlocalizedNameWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1;
- (id)unlocalizedNameWithContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1 asIfShowingAllExtensions:(id)arg2;
