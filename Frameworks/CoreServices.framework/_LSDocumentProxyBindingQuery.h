...
- (void)filterOpenRestrictedBindings:(struct vector<LSBinding, std::__1::allocator<LSBinding> > { struct LSBinding {} *x1; struct LSBinding {} *x2; struct __compressed_pair<LSBinding *, std::__1::allocator<LSBinding> > { struct LSBinding {} *x_3_1_1; } x3; }*)arg1 connection:(id)arg2 context:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg3 earlyYield:(id /* block */)arg4;
- (id)handlerRank;
