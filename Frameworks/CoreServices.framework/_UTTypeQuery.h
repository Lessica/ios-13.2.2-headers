...
@property (setter=_setContext:, nonatomic) /* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*_context;
...
- (/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)_context;
- (id)_init;
- (unsigned long long)_propertiesToResolve;
- (bool)_resolveInactiveDeclarations;
- (void)_setContext:(/* Warning: unhandled struct encoding: '{LSContext=@}' */ struct LSContext { id x1; }*)arg1;
