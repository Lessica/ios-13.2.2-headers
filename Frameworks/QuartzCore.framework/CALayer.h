...
@interface CALayer : NSObject <CAMediaTiming, CAPropertyInfo, CKAsyncTransactionContainer, DebugHierarchyObject_Fallback, NSSecureCoding, PXGInternalReusableView, TSDContentsScaleProviding> {
