...
@interface BorealisServer : NSObject <NSXPCListenerDelegate, VoiceTriggerInterface> {
    ...
    struct BorealisServerImpl { int (**x1)(); unsigned int x2; bool x3; bool x4; bool x5; bool x6; id x7; struct HALListener {} *x8; struct HALListener {} *x9; int x10; char *x11; int x12; struct CAMutex {} *x13; id x14; bool x15; } * serverImpl;
}
