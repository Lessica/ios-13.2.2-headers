...
@interface PKStrokeGenerator : NSObject <PKInputProvider> {
    /* Warning: unhandled struct encoding: '{PKAzimuthFilter=^^?^{PKInputProvider<PKInputPoint>}Bdqq{vector<PKInputPoint, std::__1::allocator<PKInputPoint> >=^{?}^{?}{__compressed_pair<PKInputPoint *, std::__1::allocator<PKInputPoint> >=^{?}}}qBdq@}' */ struct PKAzimuthFilter { int (**x1)(); struct PKInputProvider<PKInputPoint> {} *x2; bool x3; double x4; long long x5; long long x6; struct vector<PKInputPoint, std::__1::allocator<PKInputPoint> > { struct { /* ? */ } *x_7_1_1; struct { /* ? */ } *x_7_1_2; struct __compressed_pair<PKInputPoint *, std::__1::allocator<PKInputPoint> > { struct { /* ? */ } *x_3_2_1; } x_7_1_3; } x7; long long x8; bool x9; double x10; long long x11; id x12; } * _azimuthFilter;
    ...
    /* Warning: unhandled struct encoding: '{PKEstimatedAltitudeAndAzimuthFilter=^^?^{PKInputProvider<PKInputPoint>}BdqqqddddqBqdd@}' */ struct PKEstimatedAltitudeAndAzimuthFilter { int (**x1)(); struct PKInputProvider<PKInputPoint> {} *x2; bool x3; double x4; long long x5; long long x6; long long x7; double x8; double x9; double x10; double x11; long long x12; bool x13; long long x14; double x15; double x16; id x17; } * _estimatedAltitudeAndAzimuthFilter;
    long long  _immutableCount;
    bool  _inputHasChanged;
    /* Warning: unhandled struct encoding: '{PKInputProviderInitial=^^?@}' */ struct PKInputProviderInitial { int (**x1)(); id x2; } * _inputProvider;
    ...
    /* Warning: unhandled struct encoding: '{PKPixelSmoothingFilter=^^?^{PKInputProvider<PKInputPoint>}Bddq@}' */ struct PKPixelSmoothingFilter { int (**x1)(); struct PKInputProvider<PKInputPoint> {} *x2; bool x3; double x4; double x5; long long x6; id x7; } * _pixelSmoothingFilter;
    ...
    /* Warning: unhandled struct encoding: '{PKRulerExtremaFilter=^^?^{PKInputProvider<_PKStrokePoint>}Bdqq{vector<_PKStrokePoint, std::__1::allocator<_PKStrokePoint> >=^{_PKStrokePoint}^{_PKStrokePoint}{__compressed_pair<_PKStrokePoint *, std::__1::allocator<_PKStrokePoint> >=^{_PKStrokePoint}}}q{vector<_PKStrokePoint, std::__1::allocator<_PKStrokePoint> >=^{_PKStrokePoint}^{_PKStrokePoint}{__compressed_pair<_PKStrokePoint *, std::__1::allocator<_PKStrokePoint> >=^{_PKStrokePoint}}}@}' */ struct PKRulerExtremaFilter { int (**x1)(); struct PKInputProvider<_PKStrokePoint> {} *x2; bool x3; double x4; long long x5; long long x6; struct vector<_PKStrokePoint, std::__1::allocator<_PKStrokePoint> > { struct _PKStrokePoint {} *x_7_1_1; struct _PKStrokePoint {} *x_7_1_2; struct __compressed_pair<_PKStrokePoint *, std::__1::allocator<_PKStrokePoint> > { struct _PKStrokePoint {} *x_3_2_1; } x_7_1_3; } x7; long long x8; struct vector<_PKStrokePoint, std::__1::allocator<_PKStrokePoint> > { struct _PKStrokePoint {} *x_9_1_1; struct _PKStrokePoint {} *x_9_1_2; struct __compressed_pair<_PKStrokePoint *, std::__1::allocator<_PKStrokePoint> > { struct _PKStrokePoint {} *x_3_2_1; } x_9_1_3; } x9; id x10; } * _rulerExtremaFilter;
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{PKInputProviderInitial=^^?@}' */ struct PKInputProviderInitial { int (**x1)(); id x2; }*inputProvider;
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{PKPixelSmoothingFilter=^^?^{PKInputProvider<PKInputPoint>}Bddq@}' */ struct PKPixelSmoothingFilter { int (**x1)(); struct PKInputProvider<PKInputPoint> {} *x2; bool x3; double x4; double x5; long long x6; id x7; }*pixelSmoothingFilter;
...
- (id)init;
- (/* Warning: unhandled struct encoding: '{PKInputProviderInitial=^^?@}' */ struct PKInputProviderInitial { int (**x1)(); id x2; }*)inputProvider;
- (double)inputScale;
...
- (id)outputQueue;
- (/* Warning: unhandled struct encoding: '{PKPixelSmoothingFilter=^^?^{PKInputProvider<PKInputPoint>}Bddq@}' */ struct PKPixelSmoothingFilter { int (**x1)(); struct PKInputProvider<PKInputPoint> {} *x2; bool x3; double x4; double x5; long long x6; id x7; }*)pixelSmoothingFilter;
...
- (double)rulerWidth;
- (void)setAzimuthFilter:(/* Warning: unhandled struct encoding: '{PKAzimuthFilter=^^?^{PKInputProvider<PKInputPoint>}Bdqq{vector<PKInputPoint, std::__1::allocator<PKInputPoint> >=^{?}^{?}{__compressed_pair<PKInputPoint *, std::__1::allocator<PKInputPoint> >=^{?}}}qBdq@}' */ struct PKAzimuthFilter { int (**x1)(); struct PKInputProvider<PKInputPoint> {} *x2; bool x3; double x4; long long x5; long long x6; struct vector<PKInputPoint, std::__1::allocator<PKInputPoint> > { struct { /* ? */ } *x_7_1_1; struct { /* ? */ } *x_7_1_2; struct __compressed_pair<PKInputPoint *, std::__1::allocator<PKInputPoint> > { struct { /* ? */ } *x_3_2_1; } x_7_1_3; } x7; long long x8; bool x9; double x10; long long x11; id x12; }*)arg1;
...
- (void)setEstimatedAltitudeAndAzimuthFilter:(/* Warning: unhandled struct encoding: '{PKEstimatedAltitudeAndAzimuthFilter=^^?^{PKInputProvider<PKInputPoint>}BdqqqddddqBqdd@}' */ struct PKEstimatedAltitudeAndAzimuthFilter { int (**x1)(); struct PKInputProvider<PKInputPoint> {} *x2; bool x3; double x4; long long x5; long long x6; long long x7; double x8; double x9; double x10; double x11; long long x12; bool x13; long long x14; double x15; double x16; id x17; }*)arg1;
- (void)setInputProvider:(/* Warning: unhandled struct encoding: '{PKInputProviderInitial=^^?@}' */ struct PKInputProviderInitial { int (**x1)(); id x2; }*)arg1;
...
- (void)setPixelSmoothingFilter:(/* Warning: unhandled struct encoding: '{PKPixelSmoothingFilter=^^?^{PKInputProvider<PKInputPoint>}Bddq@}' */ struct PKPixelSmoothingFilter { int (**x1)(); struct PKInputProvider<PKInputPoint> {} *x2; bool x3; double x4; double x5; long long x6; id x7; }*)arg1;
