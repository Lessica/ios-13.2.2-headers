...
@property (nonatomic) /* Warning: unhandled struct encoding: '{queue={object=@}}' */ struct queue { struct object { id x_1_1_1; } x1; } high_priority_root_queue;
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{queue={object=@}}' */ struct queue { struct object { id x_1_1_1; } x1; } scratch_queue;
...
- (/* Warning: unhandled struct encoding: '{queue={object=@}}' */ struct queue { struct object { id x_1_1_1; } x1; })high_priority_root_queue;
...
- (/* Warning: unhandled struct encoding: '{queue={object=@}}' */ struct queue { struct object { id x_1_1_1; } x1; })scratch_queue;
...
- (id)send_io_message:(/* Warning: unhandled struct encoding: '{XPC_Message_Payload=II@}' */ struct XPC_Message_Payload { unsigned int x1; unsigned int x2; id x3; })arg1;
...
- (void)setHigh_priority_root_queue:(/* Warning: unhandled struct encoding: '{queue={object=@}}' */ struct queue { struct object { id x_1_1_1; } x1; })arg1;
...
- (void)setScratch_queue:(/* Warning: unhandled struct encoding: '{queue={object=@}}' */ struct queue { struct object { id x_1_1_1; } x1; })arg1;
