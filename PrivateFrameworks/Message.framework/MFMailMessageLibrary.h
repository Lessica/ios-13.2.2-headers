...
- (void)_iterateStatement:(id)arg1 connection:(id)arg2 withProgressMonitor:(id)arg3 andRowHandler:(int (*)arg4 context:(const struct { id x1; id x2; float x3; unsigned long long x4; double x5; unsigned int x6; unsigned int x7; struct sqlite3 {} *x8; bool x9; id x10; }*)arg5;
