...
@interface PLReframeService : NSObject {
    long long  _cancellationGenerationCounter;
...
- (id)enqueueReframeRequestForAssetUUID:(id)arg1 imageConversionClient:(id)arg2 videoConversionClient:(id)arg3 isOnDemand:(bool)arg4 completionHandler:(id /* block */)arg5;
