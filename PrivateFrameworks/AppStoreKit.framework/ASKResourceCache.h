...
@interface ASKResourceCache : NSObject {
    struct NSCache { Class x1; id x2; /* Warning: Unrecognized filer type: '5' using 'void*' */ void*x3; void *x4; void*x5; void *x6; } * _contents;
...
- (struct NSCache { Class x1; id x2; /* Warning: Unrecognized filer type: '5' using 'void*' */ void*x3; void *x4; void*x5; void *x6; }*)contents;
- (void)dealloc;
