...
+ (void)decodeArguments:(id)arg1 outArgs:(out /* Warning: unhandled array encoding: '[10@]' */ id)arg2 fromMessage:(id)arg3 forConnection:(id)arg4;
+ (void)encodeArguments:(id)arg1 inArgs:(in /* Warning: unhandled array encoding: '[10@]' */ id)arg2 toMessage:(id)arg3 forConnection:(id)arg4;
+ (void)invokeMethod:(id)arg1 onTarget:(id)arg2 withMessage:(id)arg3 forConnection:(id)arg4;
+ (/* Warning: unhandled struct encoding: '{?=cB@}' */ struct { BOOL x1; bool x2; id x3; })invokeMethod:(id)arg1 onTarget:(id)arg2 withObjects:(in /* Warning: unhandled array encoding: '[10@]' */ id)arg3;
