...
- (id)serializedDataForUnknownValue:(int)arg1 forKey:(union { bool x1; int x2; long long x3; unsigned int x4; unsigned long long x5; float x6; double x7; id x8; id x9; }*)arg2 keyDataType:(unsigned char)arg3;
