...
@interface SMBPiston : NSObject {
    ...
    struct smb_session { 
        ...
        unsigned long long session_message_id; 
        unsigned int session_credits_granted; 
        unsigned int session_credits_ss_granted; 
        unsigned int session_credits_max; 
        int session_credits_wait; 
