...
- (id)syncgetSetValue:(void *)arg1 forKey:(void *)arg2 withoutNotifying:(void *)arg3; // needs 3 arg types, found 4: id, id, /* Warning: Unrecognized filer type: 'R' using 'void*' */ void*, id
- (id)syncgetSettingsAndRegisterForUpdates:(void *)arg1; // needs 1 arg types, found 2: /* Warning: Unrecognized filer type: 'R' using 'void*' */ void*, id
- (void)unregisterForUpdates:(void *)arg1; // needs 1 arg types, found 2: /* Warning: Unrecognized filer type: 'R' using 'void*' */ void*, id
