...
- (void)dealloc;
- (id)displayString;
- (void)encodeToArchive:(struct NumberCellValueArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { int x_1_2_1; } x_4_1_1; } x4; struct ArenaStringPtr { struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > {} *x_5_1_1; } x5; struct FormatStructArchive {} *x6; double x7; int x8; bool x9; bool x10; unsigned long long x11; unsigned long long x12; }*)arg1;
- (id)format;
- (unsigned long long)hash;
- (id)initWithArchive:(const struct NumberCellValueArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { int x_1_2_1; } x_4_1_1; } x4; struct ArenaStringPtr { struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > {} *x_5_1_1; } x5; struct FormatStructArchive {} *x6; double x7; int x8; bool x9; bool x10; unsigned long long x11; unsigned long long x12; }*)arg1 locale:(id)arg2;
- (id)initWithDecimal:(const struct TSUDecimal { struct { unsigned long long x_1_1_1[2]; } x1; }*)arg1 locale:(id)arg2;
