...
@interface AVTAvatar : NSObject <AVTPhysicsControllerDelegate, NSCopying> {
    ...
    struct { id x1; long long x2; } * _friendlyPoseMorphInfos;
    SCNNode * _headNode;
...
- (void)applyWeightWithThresholdingForLocation:(id)arg1 weight:(float)arg2 morphInfo:(struct { id x1; long long x2; })arg3;
- (bool)arMode;
- (void)arOffset;
- (float)arScale;
- (id)arTechniqueName;
