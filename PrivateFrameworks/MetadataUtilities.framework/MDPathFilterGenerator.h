...
- (void)addRules:(/* Warning: unhandled struct encoding: '{?=[32Q]@}' */ struct { unsigned long long x1[32]; id x2; }*)arg1 withPrefix:(id)arg2;
- (void)addRules:(/* Warning: unhandled struct encoding: '{?=[32Q]@}' */ struct { unsigned long long x1[32]; id x2; }*)arg1 withPrefix:(id)arg2 tableMapping:(id)arg3;
