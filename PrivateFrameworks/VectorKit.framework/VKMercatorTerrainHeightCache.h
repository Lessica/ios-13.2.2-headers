...
- (id).cxx_construct;
- (void).cxx_destruct;
- (double)heightForAnchor:(/* Warning: unhandled struct encoding: '{Anchor=^^?^{AnchorManager}{Mercator3<double>=[3d]}{Coordinate2D<Degrees, double>={Unit<DegreeUnitDescription, double>=d}{Unit<DegreeUnitDescription, double>=d}}@}' */ struct Anchor { int (**x1)(); struct AnchorManager {} *x2; struct Mercator3<double> { double x_3_1_1[3]; } x3; struct Coordinate2D<Degrees, double> { struct Unit<DegreeUnitDescription, double> { double x_1_2_1; } x_4_1_1; struct Unit<DegreeUnitDescription, double> { double x_2_2_1; } x_4_1_2; } x4; id x5; }*)arg1;
- (id)heightProvider;
