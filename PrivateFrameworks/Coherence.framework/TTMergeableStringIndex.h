...
@property (nonatomic, readonly) struct TopoID { struct TopoReplica { id x_1_1_1; } x1; unsigned int x2; } index;
...
- (id)context;
- (void)dealloc;
- (struct TopoID { struct TopoReplica { id x_1_1_1; } x1; unsigned int x2; })index;
- (id)initWithContext:(id)arg1 topoID:(struct TopoID { struct TopoReplica { id x_1_1_1; } x1; unsigned int x2; })arg2 affinity:(unsigned long long)arg3;
