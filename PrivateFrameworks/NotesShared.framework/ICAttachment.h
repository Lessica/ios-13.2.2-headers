...
+ (struct NSCache { Class x1; id x2; /* Warning: Unrecognized filer type: '5' using 'void*' */ void*x3; void *x4; void*x5; void *x6; }*)imageCache;
...
- (id)updateAttachmentPreviewImageWithImage:(struct UIImage { Class x1; }*)arg1 scale:(double)arg2 appearanceType:(unsigned long long)arg3 scaleWhenDrawing:(bool)arg4 metadata:(id)arg5 sendNotification:(bool)arg6;
- (id)updateAttachmentPreviewImageWithImage:(struct UIImage { Class x1; }*)arg1 scale:(double)arg2 scaleWhenDrawing:(bool)arg3 metadata:(id)arg4 sendNotification:(bool)arg5;
