...
@interface VCVideoStreamTransmitter : VCVideoTransmitterBase {
    ...
    struct tagVCRealTimeThread { unsigned int x1; unsigned int x2; struct _opaque_pthread_mutex_t { long long x_3_1_1; BOOL x_3_1_2[56]; } x3; id x4; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x5; void *x6; struct OpaqueFigThread {} *x7; int x8; BOOL x9[60]; unsigned int x10; unsigned int x11; } * _encoderThread;
