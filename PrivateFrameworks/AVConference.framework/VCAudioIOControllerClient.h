...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{_VCAudioIOControllerClientIO=^v^?@}' */ struct _VCAudioIOControllerClientIO { void *x1; int (*x2)(); id x3; }*sinkIO;
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{_VCAudioIOControllerClientIO=^v^?@}' */ struct _VCAudioIOControllerClientIO { void *x1; int (*x2)(); id x3; }*sourceIO;
...
- (/* Warning: unhandled struct encoding: '{_VCAudioIOControllerClientIO=^v^?@}' */ struct _VCAudioIOControllerClientIO { void *x1; int (*x2)(); id x3; }*)sinkIO;
- (/* Warning: unhandled struct encoding: '{_VCAudioIOControllerClientIO=^v^?@}' */ struct _VCAudioIOControllerClientIO { void *x1; int (*x2)(); id x3; }*)sourceIO;
