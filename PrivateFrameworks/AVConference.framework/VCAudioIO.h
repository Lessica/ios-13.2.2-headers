...
- (void)forceCleanup;
- (id)initWithConfiguration:(struct _VCAudioIOInitConfiguration { int x1; int x2; unsigned char x3; bool x4; id x5; id x6; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x7; void *x8; id x9; void*x10; void *x11; }*)arg1;
- (bool)isGKVoiceChat;
