...
- (id)dateValue;
- (id)defaultStateForInfo:(const struct WFRowTemplateValueInfo { Class x1; SEL x2; SEL x3; id x4; }*)arg1;
- (id)emailValue;
- (id)enumerationValue;
...
- (bool)isValueWithInfoDisplayed:(const struct WFRowTemplateValueInfo { Class x1; SEL x2; SEL x3; id x4; }*)arg1;
- (id)numberValue;
- (id)phoneValue;
