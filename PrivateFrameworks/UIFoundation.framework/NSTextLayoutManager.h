...
@interface NSTextLayoutManager : NSObject <NSSecureCoding, NSTextViewportElementProvider> {
    ...
    /* Warning: unhandled struct encoding: '{?=@@@}' */ struct { id x1; id x2; } * _softInvalidatedSegmentHead;
    NSTextContainer * _templateTextContainer;
    struct { id x1; id x2; unsigned char x3; /* Warning: Unrecognized filer type: 'G' using 'void*' */ void*x4; void*x5; void*x6; BOOL x7; void*x8; void*x9; struct CGPoint { double x_10_1_1; double x_10_1_2; } x10; struct CGSize { double x_11_1_1; double x_11_1_2; } x11; } * _textContainerEntries;
    struct { id x1; id x2; unsigned char x3; /* Warning: Unrecognized filer type: 'G' using 'void*' */ void*x4; void*x5; void*x6; BOOL x7; void*x8; void*x9; struct CGPoint { double x_10_1_1; double x_10_1_2; } x10; struct CGSize { double x_11_1_1; double x_11_1_2; } x11; } * _textContainerEntriesAccessHint;
    ...
    /* Warning: unhandled struct encoding: '{?=@@@}' */ struct { id x1; id x2; } * _textLayoutSegments;
    /* Warning: unhandled struct encoding: '{?=@@@}' */ struct { id x1; id x2; } * _textLayoutSegmentsAccessHint;
