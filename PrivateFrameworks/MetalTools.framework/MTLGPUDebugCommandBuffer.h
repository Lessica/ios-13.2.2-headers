...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct ReportBufferEntry { unsigned long long x1; id x2; })_allocReportEntryStorageForType:(unsigned long long)arg1;
- (void)_checkReportBuffers;
- (void)_encodeReportBuffer:(id)arg1 type:(unsigned long long)arg2;
- (id)_newReportBuffer;
- (struct pair<id<MTLBuffer>, unsigned long> { id x1; })_temporaryBufferWithLength:(unsigned long long)arg1;
...
- (struct pair<id<MTLBuffer>, unsigned long> { id x1; })setBytes:(const void*)arg1 length:(unsigned long long)arg2;
