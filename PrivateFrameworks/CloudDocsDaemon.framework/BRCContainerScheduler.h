...
@interface BRCContainerScheduler : NSObject <APSConnectionDelegate, BRCAppLibraryDelegate, BRCClientZoneDelegate> {
    ...
    struct _BRCOperation { Class x1; id x2; /* Warning: Unrecognized filer type: '1' using 'void*' */ void*x3; void*x4; unsigned char x5; void*x6; } * _containerMetadataSyncOperation;
    ...
    struct _BRCOperation { Class x1; id x2; /* Warning: Unrecognized filer type: '1' using 'void*' */ void*x3; void*x4; unsigned char x5; void*x6; } * _periodicSyncOperation;
    ...
    struct _BRCOperation { Class x1; id x2; /* Warning: Unrecognized filer type: '1' using 'void*' */ void*x3; void*x4; unsigned char x5; void*x6; } * _sharedDatabaseSyncOperation;
    ...
    struct _BRCOperation { Class x1; id x2; /* Warning: Unrecognized filer type: '1' using 'void*' */ void*x3; void*x4; unsigned char x5; void*x6; } * _zoneHealthSyncOperation;
