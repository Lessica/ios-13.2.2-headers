...
- (void)startWithParentOperation:(struct _BRCOperation { Class x1; id x2; /* Warning: Unrecognized filer type: '1' using 'void*' */ void*x3; void*x4; unsigned char x5; void*x6; }*)arg1;
- (void)stop;
