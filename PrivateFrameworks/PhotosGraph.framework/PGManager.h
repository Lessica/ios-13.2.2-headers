...
@interface PGManager : NSObject {
    ...
    unsigned long long  _fullGraphRebuildStamp;
    PGGraph * _graph;
    ...
    unsigned long long  _numberOfCurrentGraphAccesses;
...
- (bool)canProceedWithFullGraphRebuildStamp:(void *)arg1; // needs 1 arg types, found 2: /* Warning: Unrecognized filer type: '' using 'void*' */ void*, unsigned long long
...
- (/* Warning: Unrecognized filer type: '' using 'void*' */ void*)currentFullGraphRebuildStamp:(SEL)arg1;
