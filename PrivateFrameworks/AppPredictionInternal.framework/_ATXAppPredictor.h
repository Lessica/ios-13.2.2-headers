...
- (void)_copyValidScoreInputsFromPredictionItem:(const struct ATXPredictionItem { id x1; float x2[389]; float x3; }*)arg1 toPredictionItem:(struct ATXPredictionItem { id x1; float x2[389]; float x3; }*)arg2;
...
- (double)_predictionScoreForItem:(const struct ATXPredictionItem { id x1; float x2[389]; float x3; }*)arg1 consumerSubType:(unsigned char)arg2 scoreLogger:(id)arg3 intentType:(id)arg4;
...
- (double)predictionScoreForItem:(const struct ATXPredictionItem { id x1; float x2[389]; float x3; }*)arg1 consumerSubType:(unsigned char)arg2;
