...
+ (void)setSlotResolutionPredictionItemForTopUpcomingMediaActionContainer:(id)arg1 appActionPredictionItem:(const struct ATXPredictionItem { id x1; float x2[389]; float x3; }*)arg2 appActionLogProbability:(double)arg3;
+ (id)sharedInstance;
+ (id)yearMonthDayComponentsForDate:(id)arg1;

- (void).cxx_destruct;
- (id)actionPredictionsForStatistics:(id)arg1;
- (id)actionPredictionsForStatistics:(id)arg1 appActionPredictionItem:(const struct ATXPredictionItem { id x1; float x2[389]; float x3; }*)arg2 appActionLogProbability:(double)arg3 scoreLogger:(id)arg4;
