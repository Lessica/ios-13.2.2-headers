...
@interface ICAttachmentImageLoadingOperation : NSOperation {
    ...
    struct NSCache { Class x1; id x2; /* Warning: Unrecognized filer type: '5' using 'void*' */ void*x3; void *x4; void*x5; void *x6; } * _cache;
    NSString * _cacheKey;
...
- (struct NSCache { Class x1; id x2; /* Warning: Unrecognized filer type: '5' using 'void*' */ void*x3; void *x4; void*x5; void *x6; }*)cache;
- (id)cacheKey;
- (id)completionHandlers;
- (bool)forceFullSizeImage;
- (id)initWithCache:(struct NSCache { Class x1; id x2; /* Warning: Unrecognized filer type: '5' using 'void*' */ void*x3; void *x4; void*x5; void *x6; }*)arg1 attachment:(id)arg2 attachmentType:(short)arg3 forceFullSizeImage:(bool)arg4 completionHandler:(id /* block */)arg5;
- (void)main;
- (id)mediaURL;
...
- (void)setCache:(struct NSCache { Class x1; id x2; /* Warning: Unrecognized filer type: '5' using 'void*' */ void*x3; void *x4; void*x5; void *x6; }*)arg1;
