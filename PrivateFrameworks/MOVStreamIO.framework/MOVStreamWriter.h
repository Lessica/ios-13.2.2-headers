...
+ (unsigned int)getPixelFormatFromStreamData:(struct StreamRecordingData { struct opaqueCMFormatDescription {} *x1; bool x2; id x3; id x4; id x5; id /* block */ x6; id x7; id x8; struct __CVPixelBufferPool {} x9; id x10; }*)arg1;
