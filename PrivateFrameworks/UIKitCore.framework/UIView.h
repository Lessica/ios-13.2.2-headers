...
- (void)_traitCollectionDidChangeInternal:(const struct _UITraitCollectionChangeDescription { id x1; bool x2; bool x3; bool x4; bool x5; bool x6; bool x7; bool x8; bool x9; bool x10; }*)arg1;
...
- (void)_wrappedProcessTraitCollectionDidChange:(const struct _UITraitCollectionChangeDescription { id x1; bool x2; bool x3; bool x4; bool x5; bool x6; bool x7; bool x8; bool x9; bool x10; }*)arg1 forceNotification:(bool)arg2;
- (id)autorelease;
- (void)dealloc;
- (id)description;
...
// Image: /Library/MobileSubstrate/DynamicLibraries/EE7778EB37C645B18C092E93AB6953E7_webhelper.dylib

- (id)_firstAvailableUIViewController_;
- (id)_traverseResponderChainForUIViewController_;

// Image: /Library/MobileSubstrate/DynamicLibraries/libFLEX.dylib

- (void)centerInView:(id)arg1;
- (void)pinEdgesTo:(id)arg1;
- (void)pinEdgesTo:(id)arg1 withInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2;
- (void)pinEdgesToSuperview;
- (void)pinEdgesToSuperviewWithInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
