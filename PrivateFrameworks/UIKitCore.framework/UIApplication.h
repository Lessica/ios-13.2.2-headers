...
@interface UIApplication : UIResponder <DebugHierarchyEntryPoint_Fallback, DebugHierarchyObject_Fallback, FBSDisplayLayoutObserver, FBSUIApplicationWorkspaceDelegate, PKPushRegistryDelegate, PXPPTDelegate, UIActivityContinuationManagerApplicationContext, UIApplicationSnapshotPreparing, UIRepeatedActionDelegate, UIStatusBarStyleDelegate_SpringBoardOnly, WFApplicationContextProvider, _UIApplicationInitializationContextFactory> {
