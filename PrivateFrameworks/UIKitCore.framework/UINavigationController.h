...
@interface UINavigationController : UIViewController <DebugHierarchyObject_Fallback, GKContentRefresh, GKURLHandling, HUPreloadableViewController, HUPresentationDelegate, UIGestureRecognizerDelegatePrivate, UIInterfaceOrientationMaskOverride, UILayoutContainerViewDelegate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver> {
