...
@property (nonatomic, copy) id /* block */ cancelBlockææå¤´xxté·å£°é²å¤§å²çª;
@property (nonatomic) long long cancelButtonIndex;
@property (nonatomic, retain) id context;
@property (nonatomic) long long defaultButtonIndex;
@property (nonatomic) id delegate;
@property (nonatomic, copy) id /* block */ didDismissBlockææå¤´xxté·å£°é²å¤§å²çª;
@property (nonatomic, copy) id /* block */ didPresentBlockææå¤´xxté·å£°é²å¤§å²çª;
...
@property (nonatomic, copy) id /* block */ shouldEnableFirstOtherButtonBlockææå¤´xxté·å£°é²å¤§å²çª;
@property (nonatomic, retain) NSString *subtitle;
@property (nonatomic, copy) id /* block */ tapBlockææå¤´xxté·å£°é²å¤§å²çª;
@property (nonatomic, copy) NSString *title;
@property (getter=isVisible, nonatomic, readonly) bool visible;
@property (nonatomic, copy) id /* block */ willDismissBlockææå¤´xxté·å£°é²å¤§å²çª;
@property (nonatomic, copy) id /* block */ willPresentBlockææå¤´xxté·å£°é²å¤§å²çª;
...
+ (id)showWithTitle:(id)arg1 message:(id)arg2 cancelButtonTitle:(id)arg3 otherButtonTitles:(id)arg4 tapBlock插插头xxt闷声防大冲突:(id /* block */)arg5;
+ (id)showWithTitle:(id)arg1 message:(id)arg2 style:(long long)arg3 cancelButtonTitle:(id)arg4 otherButtonTitles:(id)arg5 tapBlock插插头xxt闷声防大冲突:(id /* block */)arg6;

- (void)_checkAlertViewDelegate插插头xxt闷声防大冲突;
- (id /* block */)cancelBlock插插头xxt闷声防大冲突;
- (id /* block */)didDismissBlock插插头xxt闷声防大冲突;
- (id /* block */)didPresentBlock插插头xxt闷声防大冲突;
- (void)setCancelBlock插插头xxt闷声防大冲突:(id /* block */)arg1;
- (void)setDidDismissBlock插插头xxt闷声防大冲突:(id /* block */)arg1;
- (void)setDidPresentBlock插插头xxt闷声防大冲突:(id /* block */)arg1;
- (void)setShouldEnableFirstOtherButtonBlock插插头xxt闷声防大冲突:(id /* block */)arg1;
- (void)setTapBlock插插头xxt闷声防大冲突:(id /* block */)arg1;
- (void)setWillDismissBlock插插头xxt闷声防大冲突:(id /* block */)arg1;
- (void)setWillPresentBlock插插头xxt闷声防大冲突:(id /* block */)arg1;
- (id /* block */)shouldEnableFirstOtherButtonBlock插插头xxt闷声防大冲突;
- (id /* block */)tapBlock插插头xxt闷声防大冲突;
- (id /* block */)willDismissBlock插插头xxt闷声防大冲突;
- (id /* block */)willPresentBlock插插头xxt闷声防大冲突;
