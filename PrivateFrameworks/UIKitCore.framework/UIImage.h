...
@interface UIImage : NSObject <DebugHierarchyValue_Fallback, MKArtworkImageSource, NSCopying, NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, UIImageJSExports, UIItemProviderPresentationSizeProviding, UIItemProviderReading, UIItemProviderWriting> {
    struct UIEdgeInsets { 
        double top; 
        double left; 
        double bottom; 
