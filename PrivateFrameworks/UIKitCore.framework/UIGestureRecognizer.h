...
- (struct CKTypedComponentAction<UIGestureRecognizer *> { unsigned long long x1; id x2; SEL x3; })ck_componentAction;
- (void)ck_setComponentAction:(struct CKTypedComponentAction<UIGestureRecognizer *> { unsigned long long x1; id x2; SEL x3; })arg1;
