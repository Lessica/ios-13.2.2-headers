...
@interface UISearchController : UIViewController <DebugHierarchyObject_Fallback, NSCoding, TSPresentable, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, _UIScrollViewScrollObserver_Internal> {
