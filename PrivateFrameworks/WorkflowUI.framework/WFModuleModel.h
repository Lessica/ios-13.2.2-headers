...
@interface WFModuleModel : NSObject <WFModuleParameterStateWriter> {
    ...
    /* Warning: unhandled struct encoding: '{CKTypedComponentAction<WFAction *, WFParameter *>="_variant"Q"_target"@"_scopeHandle"@"CKComponentScopeHandle""_selector":}' */ struct CKTypedComponentAction<WFAction *, WFParameter *> { 
...
@property (nonatomic, readonly) struct CKTypedComponentAction<> { unsigned long long x1; id x2; SEL x3; } processingCancelAction;
@property (nonatomic, readonly) struct CKTypedComponentAction<> { unsigned long long x1; id x2; SEL x3; } processingDoneAction;
...
+ (id)modelForProcessingAction:(id)arg1 withParameters:(id)arg2 cancelAction:(struct CKTypedComponentAction<> { unsigned long long x1; id x2; SEL x3; })arg3 doneAction:(struct CKTypedComponentAction<> { unsigned long long x1; id x2; SEL x3; })arg4;
+ (id)modelForSelectingParameterOfAction:(id)arg1 excludingParameters:(id)arg2 selectionAction:(struct CKTypedComponentAction<WFAction *, WFParameter *> { unsigned long long x1; id x2; SEL x3; })arg3 delegate:(id)arg4;
...
- (struct CKTypedComponentAction<WFAction *, WFParameter *> { unsigned long long x1; id x2; SEL x3; })parameterSelectionAction;
- (id)parameterStateWriter;
- (id)parameterStates;
- (id)parametersExcludedFromSelection;
- (id)parametersInListing;
- (struct CKTypedComponentAction<> { unsigned long long x1; id x2; SEL x3; })processingCancelAction;
- (struct CKTypedComponentAction<> { unsigned long long x1; id x2; SEL x3; })processingDoneAction;
